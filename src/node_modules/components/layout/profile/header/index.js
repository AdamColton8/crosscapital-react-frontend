    ...
    return (
      <div className="col-12">
        <div
          ...
          <div className="balance order-lg-0 order-1">
          ...
          <ul className="rewards d-flex align-items-baseline order-lg-2 order-3 flex-wrap">
              ...
              userWallets.length && userWallets.slice(0,3).map((wallet, i)=> {
                return (
                  ...
                  >
                    ...
                    <span className={`d-inline-block align-middle amount ${ wallet.balance ? 'text-dark' : 'text-secondary'}`}>
...

            {
              ...
              >
                <svg className="d-inline-block align-middle mr-2" width={24} height={24} viewBox="0 0 24 24" version="1.1"
                ...
                <span className={`d-inline-block align-middle amount ${ userWallets[3].balance ? 'text-dark' : 'text-secondary'}`}>
            ...
            {
              userWallets.length && userWallets[3].balance ?
              <li
                className={'reward__item bonus-reward'}
              >
                <span className={'d-inline-block align-middle bonus-ico text-white text-center'}>B</span>
          ...
          {/*<a className="profile__settings order-2 order-lg-3" href="#">*/}
            {/*<svg className="d-inline-block align-middle" width={20} height={20}>*/}
              {/*<use xlinkHref="#svg_settings" xmlnsXlink="http://www.w3.org/1999/xlink" style={{fill: '#C4C4C4'}}/>*/}
            {/*</svg>*/}
          {/*</a>*/}
        </div>
        <Modal isOpen={modalReplenish} toggle={()=>toggleModal('modalReplenish')}>
          ...
          >
              <div className="modal-header">
                ...
                <button className="close" type="button" data-dismiss="modal" aria-label="Close" onClick={()=>toggleModal('modalReplenish')}>×</button>
              </div>
                        ...
                        return(
                          ...
                          >
                            <div
                              ...
                              `}
                            >
                              <img className="payment-system__img rounded-circle d-inline-block"
                                   src={PaymentSystemsIcons[system.payment_alias]}
                                   width={44} />
                              <span className="payment-system__title d-block text-dark ui-fz-14">{system.payment}</span>
                              <span className="payment-system__balance d-block text-secondary ui-fz-14 mt-auto font-weight-bold">{userWallets.length && userWallets[index].balance}</span>
                            </div>
                          </div>
                        )
                      })
