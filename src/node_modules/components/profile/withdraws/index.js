        ...
        <div className="col-12">
          <div className="user-profile__table user-withdraws__table table-responsive">
            <table className="w-100">
              ...
              <tr>
                <th className="font-weight-normal">Transaction</th>
                <th className="font-weight-normal">Sum</th>
                <th className="font-weight-normal">Date</th>
                <th className="font-weight-normal">Status</th>
                  <th className="font-weight-normal">Rejection reason</th>
                <th className="font-weight-normal">Payment system</th>
                  ...
                  userOperations.length > 0 ? userOperations.map((operation, i)=>{
                    return(
                      <tr className="table_row" key={`operation_${i}`}>
                        ...
                        <td
                          className={`pr-4  ${statusCaseRender(operation.status)}`}
                        >
