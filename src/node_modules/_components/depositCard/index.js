      ...
      <div className="project-card__block">
        ...
        <dl className="project__details ui-fz-14 text-dark">
          ...
          <div className="line d-flex">
            ...
            <dd className="flex-1 font-weight-bold">{toFloatNumbers(deposit.earned)} / {toFloatNumbers(deposit.available)}€</dd>
          </div>
          <div className="line d-flex">
          ...
          <div className="line d-flex">
            ...
            <dd className="flex-1 font-weight-bold">{toFloatNumbers(deposit.accumulation)}€</dd>
          </div>
        </dl>
      </div>
    )
