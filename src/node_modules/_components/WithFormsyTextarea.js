...
import { addValidationRule, propTypes, withFormsy } from 'formsy-react';

class WithFormsySelect extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      touched: false
...
WithFormsySelect.propTypes = {
  ...propTypes,
};

export default withFormsy(WithFormsySelect);